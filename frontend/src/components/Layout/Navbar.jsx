...
const Navbar = ({ onToggleLeftSidebar, onToggleRightSidebar, rightSidebarCollapsed }) => {
  ...
  return (
    <nav className={`px-4 py-1 flex items-center justify-between transition-all duration-200 ${isDarkMode
      ...
      <div className="flex items-center">
        ...
        <button
          ...
          className={`mr-4 p-1.5 rounded-lg transition-all duration-200 border border-transparent focus:outline-none ${isDarkMode
        ...
        <Link to="/dashboard" className="flex items-center">
          ...
          <span className={`ml-2 text-lg font-semibold ${isDarkMode ? 'text-white' : 'text-gray-800'
      ...
      <div className="flex items-center space-x-3">
        ...
        <button
          ...
          className={`p-1.5 rounded-lg transition-all duration-200 border border-transparent focus:outline-none ${isDarkMode
        ...
        <div className="relative">
          ...
          >
            <div className={`w-7 h-7 rounded-full border flex items-center justify-center font-medium ${isDarkMode
              ? 'bg-theme-background border-gray-600/20 text-gray-300'
              : 'bg-[#DDDDDD] border-gray-400/30 text-gray-700'
              }`}>
              {user?.name?.charAt(0) || 'U'}
            </div>
            <span className={`hidden md:inline-block ${isDarkMode ? 'text-gray-300' : 'text-gray-700'
          ...
          {dropdownOpen && (
            <div className={`absolute right-0 mt-2 w-48 rounded-lg shadow-lg py-1 z-50 border ${isDarkMode
              ? 'bg-theme-card border-gray-700'
              : 'bg-white border-gray-200'
              }`}>
              <Link
                to="/profile"
                className={`block px-4 py-2 text-sm transition-all duration-200 flex items-center space-x-2 ${isDarkMode
              ...
              <button
                ...
                className={`block w-full text-left px-4 py-2 text-sm border border-transparent rounded transition-all duration-200 flex items-center space-x-2 hover:bg-red-600/20 hover:text-red-300 hover;border-red-500/30 ${isDarkMode
